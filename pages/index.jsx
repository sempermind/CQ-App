...
Keep your response to 2-3 sentences maximum. One thought. No pivoting to the program yet.`;
      ...
      // After the empathy response Ñ direct to Journey tab
      await wait(1200);
      setTyping(true);
      await wait(2200);
      setTyping(false);
      setMessages(prev => [...prev, { id: Date.now()+Math.random(), role:"coach", text:"Before we go any further Ñ take a look at your Journey tab at the bottom. Tap through all six modules and explore what is inside each one. Come back and tell me what stood out to you.", artifact:null }]);
